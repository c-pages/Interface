...
void Config::initSkins()
{
    ...
    m_skins.insert ( { Config::Skins::Skin1 , gui::Skin() } ) ;
    ...
    skin1.fenetre.txt_couleur     = sf::Color ( 150,200,200);
    skin1.fenetre.lgn_epaisseur   = 1;
    skin1.fenetre.lgn_couleur     = sf::Color ( 150,255,255 , 20 );
    skin1.fenetre.fnd_couleur     = sf::Color ( 150,255,255 , 50 );
    ...
    skin1.btnRepos.txt_couleur    = sf::Color ( 150,200,200);
    skin1.btnRepos.lgn_epaisseur  = 1;
    skin1.btnRepos.lgn_couleur    = sf::Color ( 150,255,255 , 50 );
    skin1.btnRepos.fnd_couleur    = sf::Color ( 150,255,255 , 100 );
    ...
    skin1.btnSurvol.txt_couleur   = sf::Color ( 150,200,200);
    skin1.btnSurvol.lgn_epaisseur = 1;
    skin1.btnSurvol.lgn_couleur   = sf::Color ( 150,255,255 , 150 );
    skin1.btnSurvol.fnd_couleur   = sf::Color ( 150,255,255 , 100 );
    ...
    skin1.btnPress.txt_couleur    = sf::Color ( 150,200,200);
    skin1.btnPress.lgn_epaisseur  = 1;
    skin1.btnPress.lgn_couleur    = sf::Color ( 150,255,255 , 200 );
    skin1.btnPress.fnd_couleur    = sf::Color ( 150,255,255 , 255 );
    ...
    skin1.lblTitre.txt_couleur    = sf::Color ( 150,200,200);
    skin1.lblTitre.lgn_epaisseur  = 1 ;
    skin1.lblTitre.lgn_couleur    = sf::Color ( 150,255,255 , 200 );
    skin1.lblTitre.fnd_couleur    = sf::Color ( 150,255,255 , 255 );
    ...
    skin1.lblCourant.txt_couleur  = sf::Color ( 150,200,200);
    skin1.lblCourant.lgn_epaisseur= 1;
    skin1.lblCourant.lgn_couleur  = sf::Color ( 150,255,255 , 200 );
    skin1.lblCourant.fnd_couleur  = sf::Color ( 150,255,255 , 255 );
