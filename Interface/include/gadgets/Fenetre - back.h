...
/////////////////////////////////////////////////
/// \brief Gadget  permettant de rassembler un ensemble de Gadgets au sein d'une Fenetre.
///
/////////////////////////////////////////////////
...
private:
    ...
    std::shared_ptr<Contenant>         m_contenant;           ///<  Groupe des éléments du contenu de la Fenetre. ne s'affiche pas directment, est dessiné dans m_spriteContenant
